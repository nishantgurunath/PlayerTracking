...
class Panaroma:
    def __init__(self):
        self.descriptors = cv2.xfeatures2d.SIFT_create()
        self.match_instance = cv2.BFMatcher_create(cv2.NORM_L2)
    ...
    def Detect_Feature_And_KeyPoints(self, image):
        ...
        (Keypoints, features) = self.descriptors.detectAndCompute(image, None)
    ...
    def get_Allpossible_Match(self,featuresA,featuresB):
        ...
        All_Matches = self.match_instance.knnMatch(featuresA, featuresB, 2)
